...
const serverPlans = [
  {
    name: 'Server Plan 1',
    features: ['12 Slots', '4GB RAM'],
    price: '$9.99 / month',
    description: 'High-performance servers optimized for Minecraft. Easy mod installation and 24/7 support.',
    isMostPopular: false
  },
  {
    name: 'Server Plan 2',
    features: ['24 Slots', '8GB RAM'],
    price: '$19.99 / month',
    description: 'Enhanced performance and resources for larger server needs. 24/7 support included.',
    isMostPopular: true
  },
  {
    name: 'Server Plan 3',
    features: ['48 Slots', '16GB RAM'],
    price: '$29.99 / month',
    description: 'Top-tier performance for demanding applications. Fully managed support.',
    isMostPopular: false
  }
];
